...
export const AIEditPanel: React.FC = () => {
  ...
  return (
    <div className="p-3 flex flex-col gap-4">
      {!selectedLayer ? (
        <p className="text-xs text-gray-600 text-center mt-8">Select a layer to edit</p>
      ) : (
        <>
          <div>
            <p className="text-xs text-gray-400">Layer: <span className="text-white">{selectedLayer.name}</span></p>
          </div>
